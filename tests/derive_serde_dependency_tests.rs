...
// =============================================================================
//! Verifies serde dependency resolution for generated implementations.
...
/// Verifies the runtime serde feature supplies generated serialization support.
#[test]
fn test_missing_direct_serde_dependency_compiles() {
