...
pub(in crate::formats::http) enum ContentType {
    /// A JSON media type.
    Json,
...
#[inline(always)]
#[must_use]
pub(in crate::formats::http) fn is_valid(value: &str) -> bool {
...
#[must_use]
#[inline]
pub(in crate::formats::http) fn is_json(value: &str) -> bool {
...
#[must_use]
#[inline]
pub(in crate::formats::http) fn is_ndjson(value: &str) -> bool {
...
#[must_use]
#[inline(always)]
pub(in crate::formats::http) fn is_form(value: &str) -> bool {
...
#[must_use]
#[inline]
pub(in crate::formats::http) fn is_text(value: &str) -> bool {
