...
pub(in crate::formats::http) const INVALID_JSON: &str =
...
pub(in crate::formats::http) const INVALID_NDJSON: &str =
    "<redacted: invalid NDJSON>";
...
pub(in crate::formats::http) const UNKEYED_JSON: &str =
    "<redacted: unkeyed JSON value>";
/// Replaces an HTTP body format that the redactor does not support.
pub(in crate::formats::http) const UNSUPPORTED_BODY: &str =
...
pub(in crate::formats::http) const MULTIPART_BODY: &str =
    "<redacted: multipart body>";
/// Replaces a malformed or unsupported multipart part.
pub(in crate::formats::http) const MULTIPART_PART: &str =
    "<redacted: multipart part>";
/// Replaces an opaque multipart text part.
pub(in crate::formats::http) const MULTIPART_TEXT: &str =
    "<redacted: multipart text part>";
/// Replaces multipart file contents.
pub(in crate::formats::http) const MULTIPART_FILE: &str =
    "<redacted: file part>";
